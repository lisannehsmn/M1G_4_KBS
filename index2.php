...
if(isset($_POST['submit'])){
    ...
    // PRIJS FILTEREN
    if(isset($_POST['prijsVan']) && filter_input(INPUT_GET, 'prijsVan', FILTER_SANITIZE_NUMBER_INT) && filter_has_var(INPUT_POST, 'prijsVan')){
        ...
        <div class="column1">
                ...
                <select name="categorie">
                    ...
                    while($row = $group->fetch()){
                        print("<option value='".$row['StockGroupID']."'>".$row['StockGroupName']."</option>");
                    }
                    ?>
                </select>
                <br>
